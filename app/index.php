            ...
            <div class="bottom-grid">
                ...
                <div class="panel">
                    ...
                    <div class="ann-list">
                        <?php
                        $ann = [
                            ['Ujian Tengah Semester dimulai 14 April 2026', '2 jam lalu', '#2563eb'],
                            ['Libur Nasional Hari Jumat tanggal 11 April', '5 jam lalu', '#d97706'],
                            ['Pengumpulan tugas Praktik XII RPL diperpanjang', 'Kemarin', '#059669'],
                            ['Rapat Komite Sekolah — Sabtu 12 April 08.00', 'Kemarin', '#dc2626'],
                        ];
                        foreach ($ann as $a):
                        ?>
                            <div class="ann-item">
